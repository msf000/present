...
import { ArrowRight, Calendar, User, BrainCircuit, FileText, Edit2, Save, X, Star, Medal, Clock, ShieldCheck, MessageSquare, Printer, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 print:shadow-none print:border-0 print:p-0">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-100 pb-6 mb-6 print:border-slate-300">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-600 shadow-sm border border-indigo-100 print:bg-slate-100 print:text-slate-800 print:border-slate-300">
              <User size={32} />
            </div>
            <div>
          ...
          <div className="flex gap-4 text-center">
            <div className="px-6 py-3 bg-slate-50 rounded-lg border border-slate-100 print:bg-transparent print:border-slate-300">
